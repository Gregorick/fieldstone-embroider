                      ...
                      <div className="flex items-center justify-between mt-4">
                        <div className="flex items-center border border-gray-200 rounded-lg h-9 bg-white shadow-sm">
                          ...
                          <button 
                            ...
                            className={`px-3 transition-colors ${isMaxReached ? 'text-gray-300 cursor-not-allowed' : 'text-gray-500 hover:text-black'}`}
          ...
          <div className="border-t border-gray-100 p-6 bg-white shadow-[0_-10px_40px_rgba(0,0,0,0.05)] z-20 relative">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link 
                ...
                className={`w-full h-14 text-[11px] font-black uppercase tracking-[0.2em] rounded-xl shadow-xl flex items-center justify-center gap-2 transition-colors ${
              ...
              >
                ...
                {hasStockIssues ? "Resolve Stock Issues to Checkout" : "Proceed to Checkout"}
              </Link>
            </div>
          </div>
        )}
