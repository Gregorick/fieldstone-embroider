...
function ProductPageContent() {
  ...
  const DISCLOSURES = [
    ...
    { id: "shipping", icon: <Truck size={16}/>, title: "Turnaround & Shipping", content: "Standard orders: 7–10 business days after proof approval. Rush orders available — contact us before ordering. New logos require digitizing — allow 1 additional business day." },
  ];
